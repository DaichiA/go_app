...
type ComplexityRoot struct {
	...
	Query struct {
		Todo  func(childComplexity int, id model.ID) int
...
type QueryResolver interface {
	...
	Todo(ctx context.Context, id model.ID) (*model.Todo, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.todo":
		...
		return e.complexity.Query.Todo(childComplexity, args["Id"].(model.ID)), true
...
func (ec *executionContext) field_Query_todo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["Id"]; ok {
		...
		arg0, err = ec.unmarshalNId2graphqlᚋgraphᚋmodelᚐID(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_todo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Todo(rctx, fc.Args["Id"].(model.ID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalNId2graphqlᚋgraphᚋmodelᚐID(ctx context.Context, v interface{}) (model.ID, error) {
